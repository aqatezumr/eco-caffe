...
if (!function_exists('kale_get_defaults')) {
function kale_get_defaults() {
    ...
    $kale_defaults['kale_blog_feed_excerpt_show']           = 1;
    ...
    $kale_defaults['kale_posts_posts_nav_show_category']    = 1;
