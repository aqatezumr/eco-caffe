...
if ( ! function_exists( 'cafe_elementor_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function cafe_elementor_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
...
if ( ! function_exists( 'cafe_elementor_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function cafe_elementor_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Cafe_Elementor_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
