...
function cafe_elementor_enqueue_google_fonts() {
	...
	wp_enqueue_style(
		'Jost',
		cafe_elementor_wptt_get_webfont_url( 'https://fonts.googleapis.com/css2?family=Jost:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap' ),
		array(),
		'1.0'
	);
}
...
if (!function_exists('cafe_elementor_enqueue_scripts')) {
	...
	function cafe_elementor_enqueue_scripts() {
		...
		wp_style_add_data('cafe-elementor-style', 'rtl', 'replace');
	...
	echo '<div class="notice notice-info wpele-activation-notice is-dismissible">';
		echo '<div class="notice-body">';
			echo '<div class="notice-content">';
				...
				echo '<span><a href="'. esc_url( admin_url( 'themes.php?page=cafe_elementor_about' ) ) .'" class="button button-notice">'. esc_html__( 'GET STARTED', 'cafe-elementor' ) .'</a></span>';
				echo '<span><a href="'. esc_url( CAFE_ELEMENTOR_BUY_NOW ) .'" class="button button-notice" target="_blank" >'. esc_html__( 'BUY NOW', 'cafe-elementor' ) .'</a></span>';
				echo '<span><a href="'. esc_url( CAFE_ELEMENTOR_LIVE_DEMO ) .'" class="button button-notice" target="_blank" >'. esc_html__( 'DEMO', 'cafe-elementor' ) .'</a></span>';
			echo '</div>';
...
function cafe_elementor_enqueue_setting() {
...
add_action('after_setup_theme', 'cafe_elementor_enqueue_setting');
